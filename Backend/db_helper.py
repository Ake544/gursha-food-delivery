...
def user_order_history(user_id: int):
    ...
    SELECT 
        o.order_id, 
        MAX(o.total_price) as total_price,  -- ✅ Use aggregate function
        MAX(ot.status) as status,           -- ✅ Use aggregate function  
        MAX(ot.time) as order_date,         -- ✅ Use aggregate function
    ...
    WHERE o.user_id = %s
    GROUP BY o.order_id  -- ✅ Only group by order_id
